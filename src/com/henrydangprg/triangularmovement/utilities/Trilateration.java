...
public class Trilateration {
	 ...
	 * 
	 * <p>3 Coordinates are set to be the center of 3 spheres. 
	 * They <b>MUST</b> be in the order of left vertex, right
	 * vertex, and top vertex.
	 * The z axis must also be the same throughout all
	 * 3 vertices. 
	 * Otherwise, trilateration will not work.
	 * 
	 * <p>The coordinates will be translated if the left vertex
	 * is not at the origin.
	 * 
	 * @param leftVertex   The coordinate of the left vertex.
	 * @param rightVertex  The coordinate of the right vertex.
	 * @param topVertex    The coordinate of the top vertex.
	 */
	 ...
	 * 
	 * <p>Creates a vector to move the trilaterated point
	 * to its position in the untranslated triangle.
	 */
	...
	/**
	 * Controls whether trilateration will return the
	 * intersection above or below the Z axis.
	 * 
	 * @param calcBelow
	 */
	public void calcBelow(boolean calcBelow) {
		if (calcBelow) this.calcBelow = true;
		else this.calcBelow = false;
	}
	
	/**
	 * Calculates the point of intersection of 3 spheres.
	 * 
	 * <p>The distances from a vertex to a point is treated
	 * as a radius of a sphere. This will calculate the
	 * intersection of the 3 spheres.
	 * 
	 * <p>Returns the intersection above the Z axis if 
	 * calcBelow is true, else it will return the
	 * intersection below the Z axis.
	 * 
	 * @param distance1  distance from left vertex to point.
	 * @param distance2  distance from right vertex to point.
	 * @param distance3  distance from top vertex to point.
	 * @return           the coordinate of intersection rounded to the hundred thousandth place.
	 */
