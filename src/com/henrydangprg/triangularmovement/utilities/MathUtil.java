...
public class MathUtil {
     ...
     * @return itself if it does not exceed its range, else it will return its
     ...
     * 
     * <p>
     * Subtracts the end distance from the start distance, and divides by the
     * time elapsed to get the speed.
     * 
     * @param start
     *            the start distance.
     * @param end
    ...
    /**
     * Returns the length of the hypotenuse given the length of two legs of a
     * right triangle.
     * 
     * @param a
     *            the first leg.
     ...
     * 
     * <p>
     * Given a slope, a y-intercept, and a boolean, it will create an
     * inequality. It will check if a coordinate satisfies this inequality.
     * 
     * @param slope
     *            the slope of the inequality.
     * @param yintercept
     *            the y-intercept of the inequality.
     * @param coord
     *            the coordinate checked in this inequality.
     * @param isMore
     *            determines whether the point needs to be more or less than the
     *            inequality.
	...
	if (isMore) {
	    if (coord.getY() >= slope * coord.getX() + yintercept)
		return true;
	} else {
	    if (coord.getY() <= slope * coord.getX() + yintercept)
		return true;
