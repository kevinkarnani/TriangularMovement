...
public class Vector {
    ...
    /**
     * Calculates the x, y, and z components from the magnitude and angle
     */
    ...
    /**
     * Calculates the x, y, and z components from a given magnitude and angle in
     * degrees.
     * 
     * @param magnitude
     *            the magnitude of the vector.
     ...
     * 
     * @param coord
     *            the coordinate being added by a vector.
     * @param vector
     ...
     * 
     * @param coord
     *            the coordinate being subtracted by a vector.
     * @param vector
     ...
     * 
     * @param amplify
     *            the value amplifying this vector.
     */
    ...
    /**
     * Resets the vector by setting the x, y, z components, magnitude, and angle
     * to 0.
     */
