...
public class Triangle {
	 ...
	 * 
	 * <p>Calculates the borders of the triangle and creates inequalities
	 * for the triangle.
	 * 
	 * <p>Creates a visual representation of the triangle for JavaFX.
	 * 
	...
	/**
	 * Calculates the slope and y-intercept from left to top,
	 * top to right, and left to right.
	 */
	...
	/**
	 * Checks if a coordinate is within a triangle's dimensions through 5 inequalities.
	 * 3 inequalities are used for the sides of the triangle, and 2 inequalities
	 * are used to check the height of the triangle.
	 * 
	 * @param coord  the coordinate of an object.
